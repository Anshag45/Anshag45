...
I'm a passionate Computer Science student at **VIT Bhopal**, specializing in **Full-Stack Development**, **AI/ML**, and **Cross-Platform Mobile Apps**. I love building intelligent systems and solving real-world problems through scalable code.

- 🎓 **B.Tech CSE @ VIT Bhopal (CGPA: 8.96/10)**
- 💡 **Full-Stack Developer** (React, Next.js, Node.js, Firebase)
- 🧠 **AI/ML Practitioner** (TensorFlow, scikit-learn, Gemini API)
- 🏆 **Competitive Programmer** with **495+ LeetCode** problems solved
- 📱 **Flutter Developer** crafting cross-platform applications  
...
- 🥈 **NPTEL Silver Medalist** – Cloud Computing (Top 2%)
- ⭐ **Flipkart GRiD 7.0 Semi-Finalist** (Top 160k+ participants)
- 🏅 **Walmart Global Tech Sparkathon** – Retail innovation contributor
- 📊 Skilled in **Data Visualization using Tableau & PowerBI**
...
![Vapi AI](https://img.shields.io/badge/Vapi_AI-6A0DAD?style=for-the-badge&logo=voice&logoColor=white)
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=Anshag45&label=Profile+Views&color=blueviolet&style=flat" />
</p>
...
<p align="center">
  ⚡ <strong>Fun Fact:</strong> The best code is written with a cup of coffee ☕ and good music 🎧!
</p>
